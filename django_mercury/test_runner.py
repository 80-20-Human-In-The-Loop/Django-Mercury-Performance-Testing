...
class EducationalTestResult(TextTestResult):
    ...
    def __init__(self, *args, **kwargs) -> None:
        # Remove educational_monitor parameter
        kwargs.pop("educational_monitor", None)
...
class EducationalTestRunner(DiscoverRunner):
    ...
    def __init__(self, *args, **kwargs) -> None:
        ...
        # Educational mode moved to CLI plugins
    ...
    def _setup_educational_mode(self):
        ...
        # Educational components moved to CLI plugins
        self.educational_monitor = None
    ...
    def build_suite(self, test_labels=None, **kwargs):
        ...
        if self.educational_mode and self.console:
            ...
            self.console.print(f"[green]✓[/green] Found [cyan]{test_count}[/cyan] test(s) to run\n")
    ...
    def run_suite(self, suite, **kwargs):
        ...
        if self.educational_mode:
            # Use our custom result class for basic metrics tracking
    ...
    def _show_educational_summary(self, result):
        ...
        if self.console and RICH_AVAILABLE:
            ...
            table = Table(
                title="🎓 Educational Testing Summary", show_header=True, title_style="bold cyan"
            )
            ...
            table.add_row(
                "Tests Passed", str(result.testsRun - len(result.failures) - len(result.errors))
            )
...
def run_tests_with_education(test_labels=None, verbosity=1, interactive=True, **kwargs):
    ...
    # Create runner
    runner = EducationalTestRunner(verbosity=verbosity, interactive=interactive, **kwargs)

...
def get_c_extensions():
    ...
    extensions = [
        ...
        Extension(
            ...
            sources=[
                'django_mercury/c_core/metrics_wrapper.c',  # Python wrapper
        ...
        Extension(
            ...
            sources=[
                'django_mercury/c_core/analyzer_wrapper.c',  # Python wrapper
        ...
        Extension(
            ...
            sources=[
                'django_mercury/c_core/orchestrator_wrapper.c',  # Python wrapper

...
class TestEduLiteColorScheme(unittest.TestCase):
    ...
    def test_memory_specific_colors(self):
    ...
    def test_query_specific_colors(self):
...
class TestColorMode(unittest.TestCase):
    ...
    def test_color_mode_enum_consistency(self):
...
class TestPerformanceColors(unittest.TestCase):
    ...
    def test_color_detection_never_mode(self):
    ...
    def test_color_detection_always_mode(self):
    ...
    def test_color_detection_no_color_env_var(self):
    ...
    def test_color_detection_force_color_env_var(self):
    ...
    def test_color_detection_clicolor_disabled(self):
    ...
    def test_colorize_rich_mode(self, mock_console_class):
    ...
    def test_colorize_rich_fallback(self):
    ...
    def test_query_color_thresholds(self):
    ...
    def test_format_metric_value_time_units(self):
    ...
    def test_format_metric_value_memory_units(self):
    ...
    def test_format_metric_value_query_units(self):
    ...
    def test_format_metric_value_with_threshold(self):
...
class TestGlobalFunctions(unittest.TestCase):
    ...
    def test_get_status_icon_case_insensitive(self):
...
class TestColorDetection(unittest.TestCase):
    ...
    def test_color_detection_logging(self):

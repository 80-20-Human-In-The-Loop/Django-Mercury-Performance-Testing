...
class TestMercuryEducationalCLI(unittest.TestCase):
    ...
    def test_display_welcome_without_console(self):
    ...
    def test_display_welcome_with_console(self):
    ...
    def test_run_educational_test_django_not_configured(self, mock_import):
    ...
    def test_run_educational_test_success(self):
    ...
    def test_show_learning_summary_without_console(self):
    ...
    def test_show_learning_summary_with_console(self):
...
class TestCLIMain(unittest.TestCase):
    ...
    def test_main_reset_progress(self, MockCLI):
    ...
    @patch('django_mercury.python_bindings.cli.MercuryEducationalCLI')
    def test_main_educational_mode(self, MockCLI):
        """Test --edu flag."""
        mock_cli_instance = Mock()
    ...
    @patch('django_mercury.python_bindings.cli.MercuryEducationalCLI')
    def test_main_agent_mode(self, MockCLI):
        """Test --agent flag."""
        mock_cli_instance = Mock()
    ...
    @patch('django_mercury.python_bindings.cli.MercuryEducationalCLI')
    def test_main_with_test_path(self, MockCLI):
    ...
    @patch('django_mercury.python_bindings.cli.MercuryEducationalCLI')
    def test_main_default_mode(self, MockCLI):
